...
| `runner-init-script`                                                                                                                                                              | Optional. Used only with the `start` mode. | Specifies bash commands to run at instance init.  It's useful for installing dependencies with apt-get, yum, etc.<br><br> |
